...
public class L3_mbyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_mby);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3mbydj);

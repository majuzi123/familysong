...
public class L3_skl2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_skl2);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3skl2);

...
public class L3_qjgActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_qjg);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3qjg);

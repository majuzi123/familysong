...
import com.example.familysong.N.N3.N3_skl2Activity;
import com.example.familysong.R;

public class L3_skl1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_skl1);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3skl1);

package com.example.familysong.L.L5;
...
import com.example.familysong.L.LActivity;
import com.example.familysong.N.N5.N5_2Activity;
import com.example.familysong.N.NActivity;
import com.example.familysong.R;

public class L5_3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l53);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l5_3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, L5_2Activity.class);
        //执行意图

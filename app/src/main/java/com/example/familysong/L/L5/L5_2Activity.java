...
import com.example.familysong.N.N5.N5_3Activity;
import com.example.familysong.R;

public class L5_2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l52);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l5_2);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, L5_3Activity.class);
        //执行意图
        startActivity(intent);
    }

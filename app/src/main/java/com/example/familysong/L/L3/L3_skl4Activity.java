...
public class L3_skl4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_skl4);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3skl4);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, L3_skl3Activity.class);
        //执行意图

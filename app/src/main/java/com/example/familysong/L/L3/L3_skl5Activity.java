...
public class L3_skl5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_l3_skl5);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.l3skl5);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, L3_skl6Activity.class);
        //执行意图
        startActivity(intent);
    }

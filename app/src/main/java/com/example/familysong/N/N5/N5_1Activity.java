...
import com.example.familysong.H.H5.H5_2Activity;
import com.example.familysong.H.HActivity;
import com.example.familysong.N.NActivity;
import com.example.familysong.R;

public class N5_1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_n51);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.n5_1);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, N5_2Activity.class);
        //执行意图
        startActivity(intent);
    }

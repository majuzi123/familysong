...
public class N3_skl3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_n3_skl3);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.n3skl3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, N3_skl2Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(this, N3_skl4Activity.class);
        //执行意图
        startActivity(intent);
    }

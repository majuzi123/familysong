...
public class N3_skl2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_n3_skl2);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.n3skl2);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, N3_skl3Activity.class);
        //执行意图
        startActivity(intent);
    }

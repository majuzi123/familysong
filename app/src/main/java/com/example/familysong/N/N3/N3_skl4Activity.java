...
public class N3_skl4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_n3_skl4);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.n3skl4);

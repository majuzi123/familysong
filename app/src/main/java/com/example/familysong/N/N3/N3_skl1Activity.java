...
import com.example.familysong.H.H3.H3_skl2Activity;
import com.example.familysong.R;

public class N3_skl1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_n3_skl1);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.n3skl1);

...
public class H3_skl1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h3_skl1);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h3skl1);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, H3_skl2Activity.class);
        //执行意图
        startActivity(intent);
    }

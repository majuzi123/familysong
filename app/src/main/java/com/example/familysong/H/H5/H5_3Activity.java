...
public class H5_3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h53);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h5_3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, H5_2Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(this, H5_4Activity.class);
        //执行意图
        startActivity(intent);
    }

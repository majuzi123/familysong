...
public class H3_skl4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h3_skl4);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h3skl4);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, H3_skl3Activity.class);
        //执行意图

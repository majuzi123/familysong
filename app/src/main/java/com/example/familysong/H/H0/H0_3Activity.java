...
import com.example.familysong.F.F0.F0_3Activity;
import com.example.familysong.R;

public class H0_3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)//生命周期
    {
        ...
        //创建视频资源的文件路径
        String url="android.resource://"+getPackageName()+"/"+R.raw.h0hdy;
        Uri uri= Uri.parse(url);
        videoView.setVideoURI(uri);//将要播放的视频路径指定给控件
        //创建一个视频的控制器
        mediaController=new MediaController(H0_3Activity.this);
        //J将控制器交给视频播放的控件

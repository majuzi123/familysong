...
public class H3_skl6Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h3_skl6);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h3skl6);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, H3_skl5Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(this, H3_skl7Activity.class);
        //执行意图
        startActivity(intent);
    }

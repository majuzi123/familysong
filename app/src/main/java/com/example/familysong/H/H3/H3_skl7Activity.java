...
public class H3_skl7Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h3_skl7);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h3skl7);

...
public class H3_qjgActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h3_qjg);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.hqjg);

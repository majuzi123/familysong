...
import com.example.familysong.F.F5.F5_2Activity;
import com.example.familysong.F.FActivity;
import com.example.familysong.H.HActivity;
import com.example.familysong.R;

public class H5_1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h51);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h5_1);

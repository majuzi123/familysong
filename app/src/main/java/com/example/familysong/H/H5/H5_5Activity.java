...
public class H5_5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h55);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h5_5);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, H5_6Activity.class);
        //执行意图
        startActivity(intent);
    }

package com.example.familysong.H.H5;
...
public class H5_4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_h54);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.h5_4);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, H5_3Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(this, H5_5Activity.class);
        //执行意图
        startActivity(intent);
    }

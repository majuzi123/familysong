...
public class B3_skl5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b3_skl5);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b3skl5);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B3_skl5Activity.this, B3_skl4Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B3_skl5Activity.this, B3Activity.class);
        //执行意图
        startActivity(intent);
    }

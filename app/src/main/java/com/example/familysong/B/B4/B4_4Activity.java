...
public class B4_4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b44);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b4_4);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B4_4Activity.this, B4_3Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B4_4Activity.this, B4_5Activity.class);
        //执行意图
        startActivity(intent);
    }

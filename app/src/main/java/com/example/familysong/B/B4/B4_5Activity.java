...
public class B4_5Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b45);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b4_5);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B4_5Activity.this, B4_4Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B4_5Activity.this, B4_6Activity.class);
        //执行意图
        startActivity(intent);
    }

...
public class B1_3pinyinActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b13pinyin);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b_pyg);

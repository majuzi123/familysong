...
public class B3_skl2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b3_skl2);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b3skl2);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B3_skl2Activity.this, B3_skl1Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B3_skl2Activity.this, B3_skl3Activity.class);
        //执行意图
        startActivity(intent);
    }

...
public class B4_7Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b47);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b4_7);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B4_7Activity.this, B4_6Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B4_7Activity.this, B4_8Activity.class);
        //执行意图
        startActivity(intent);
    }

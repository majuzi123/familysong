...
public class B4_8Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b48);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b4_8);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B4_8Activity.this, B4_7Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B4_8Activity.this, BActivity.class);
        //执行意图
        startActivity(intent);
    }

...
public class B1_2bijiaoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b12bijiao);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b_bjg);

...
public class B2_2cyjlActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b22cyjl);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b2_cyjl);
        MediaPlayer mediaPlayer1=MediaPlayer.create(this,R.raw.ji2);

...
public class B2_1mygActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b21myg);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b2_myg);

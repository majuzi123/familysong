...
public class B4_3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b43);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b4_3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B4_3Activity.this, B4_2Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B4_3Activity.this, B4_4Activity.class);
        //执行意图
        startActivity(intent);
    }

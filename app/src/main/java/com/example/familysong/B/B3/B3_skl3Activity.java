...
public class B3_skl3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b3_skl3);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b3skl3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(B3_skl3Activity.this, B3_skl2Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(B3_skl3Activity.this, B3_skl4Activity.class);
        //执行意图
        startActivity(intent);
    }

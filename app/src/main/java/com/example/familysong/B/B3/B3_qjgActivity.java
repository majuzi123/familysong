...
public class B3_qjgActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b3_qjg);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.b3_qjg);

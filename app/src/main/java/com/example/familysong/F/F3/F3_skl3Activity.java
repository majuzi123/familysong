...
import com.example.familysong.B.B3.B3_skl4Activity;
import com.example.familysong.B.B3.B3_skl5Activity;
import com.example.familysong.R;

public class F3_skl3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f3_skl3);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f3skl3);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, F3_skl2Activity.class);
        //执行意图
        startActivity(intent);
    }
    public void houye1(View view) {
        Intent intent=new Intent(this, F3Activity.class);
        //执行意图
        startActivity(intent);
    }

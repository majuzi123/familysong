...
public class F1_1youdaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)//生命周期
    {
        ...
        setContentView(R.layout.activity_f11youdao);
        videoView1=findViewById(R.id.videoplay1);
        icon1=findViewById(R.id.icon1);
        //创建视频资源的文件路径
        String url1="android.resource://"+getPackageName()+"/"+R.raw.f1;
        Uri uri1= Uri.parse(url1);
        //将要播放的视频路径指定给控件
        videoView1.setVideoURI(uri1);
        //创建一个视频的控制器
        mediaController=new MediaController(com.example.familysong.F.F1.F1_1youdaoActivity.this);
        //J将控制器交给视频播放的控件

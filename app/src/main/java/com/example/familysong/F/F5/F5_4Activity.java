package com.example.familysong.F.F5;
...
import com.example.familysong.B.B4.B4_7Activity;
import com.example.familysong.B.B4.B4_8Activity;
import com.example.familysong.B.BActivity;
import com.example.familysong.F.FActivity;
import com.example.familysong.R;

public class F5_4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f54);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f5_4);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, F5_3Activity.class);
        //执行意图

...
public class F3_skl2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f3_skl2);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f3skl2);
    ...
    public void houye1(View view) {
        Intent intent=new Intent(this, F3_skl3Activity.class);
        //执行意图
        startActivity(intent);
    }

...
public class F3_skl1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f3_skl1);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f3skl1);

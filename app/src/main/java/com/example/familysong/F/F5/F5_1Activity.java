...
import com.example.familysong.B.B4.B4_2Activity;
import com.example.familysong.B.BActivity;
import com.example.familysong.F.FActivity;
import com.example.familysong.R;

public class F5_1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f51);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f5_1);

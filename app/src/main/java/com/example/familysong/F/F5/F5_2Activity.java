...
public class F5_2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_f52);
        MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.f5_2);
    ...
    public void qianye1(View view) {
        Intent intent=new Intent(this, F5_1Activity.class);
        //执行意图
